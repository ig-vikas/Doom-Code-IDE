...
A Lightweight(18 MB) CPP IDE built with **Tauri**, **React**, and **Monaco Editor** — designed for speed, customization, and a seamless coding experience.
...
- **Radial Menu** — Custom radial menu for quick access to commands, with custom animations
