...
export const defaultMenus: MenuDefinition[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { type: 'separator' },
      { id: 'view-zoomin', label: 'Zoom In', command: 'view.zoomIn', keybinding: 'Ctrl+=' },
      { id: 'view-zoomout', label: 'Zoom Out', command: 'view.zoomOut', keybinding: 'Ctrl+-' },
      { id: 'view-zoomreset', label: 'Reset Zoom', command: 'view.zoomReset', keybinding: 'Ctrl+0' },
      { type: 'separator' },
